...
class __TwigTemplate_dbd25ebbbff7a812cc890668890307ef25e16476fdd1daceb7ca2ffd43bed709 extends Twig_Template
{
...
";
    ...
    <script type=\"text/javascript\">
        ...
        \$(document).ready(function () {
                ...
                \$.each(data, function (idx, d) {
                    ...
                    \$.each(d.times, function (i, time) {
                        ...
                        for (var j = s; j < e + 1; j++) {
                            ...
                            var \$li = \$('<li><button data-time=\"' + dateTime + '\" type=\"button\" class=\"btn-time inverted btn btn-info btn-lg\">' + timeStr + '</button></li>')
                            \$ul.append(\$li);
                            timeStr = j.toString() + \":\" + \"30\";
                            
                            dateTime = dateStr + ' ' + timeStr;
                            \$li = \$('<li><button data-time=\"' + dateTime + '\" type=\"button\" class=\"btn-time inverted btn btn-info btn-lg\">' + timeStr + '</button></li>');
                            \$ul.append(\$li);
                        }
                    });
                    \$timeslots.append(\$ul);
            ...
            \$('#doctor').bind('click', '.btn-time', function (e) {
                e.preventDefault();
...
{% endblock %}", "doctors/drdescription.html.twig", "/home/cp4809/clinic.ipd10.com/templates/doctors/drdescription.html.twig");
    }
}
