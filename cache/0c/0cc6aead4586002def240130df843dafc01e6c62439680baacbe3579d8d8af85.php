...
";
    ...
    <script type=\"text/javascript\">
        ...
        \$(document).ready(function () {
                ...
                \$.each(data, function (idx, d) {
                    ...
                    \$.each(d.times, function (i, time) {
                        ...
                        for (var j = s; j < e + 1; j++) {
                            ...
                            var \$li = \$('<li><button type=\"button\" class=\"inverted btn btn-info btn-lg\" data-toggle=\"modal\" data-target=\"#myModal\" onclick=\"selectTimeModal(\\'' + timeStr + '\\')\">' + timeStr + '</button></li>')
                            \$ul.append(\$li);
                            timeStr = j.toString() + \":\" + \"30\";
                            \$li = \$('<li><button type=\"button\" class=\"inverted btn btn-info btn-lg\" data-toggle=\"modal\" data-target=\"#myModal\" data-whatever=\"timeStr\">' + timeStr + '</button></li>');
                            \$ul.append(\$li);
                        }
                    });
                    \$timeslots.append(\$ul);
            ...
            var getDate = function (start) {
                var url = 'http://clinic.ipd10.com/avtime/' + doctorId + '/' + start;
                \$.ajax({
                    url: url,
  ...
  modal.find('.modal-body p').text('Your appointment is:' + recipient);
});


\$('#myModal').on('show.bs.modal', function(e) {
    var userid = \$(e.relatedTarget).data('whatever');
...
";
    ...
    {
        return array (  507 => 426,  495 => 416,  484 => 414,  480 => 412,  476 => 411,  428 => 366,  418 => 359,  413 => 358,  409 => 357,  401 => 355,  397 => 353,  394 => 352,  51 => 13,  40 => 5,  37 => 4,  31 => 3,  11 => 1,);
    }
